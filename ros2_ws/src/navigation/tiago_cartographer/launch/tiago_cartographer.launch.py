# Usage:
#   0. Install (First time only): sudo apt update && sudo apt install ros-humble-cartographer ros-humble-cartographer-ros -y
#   1. Run controller: ~/tiago-delivery/external/tiago_isaac$ python3 tiago_example_controller.py
#   2. Launch SLAM: ~/tiago-delivery/ros2_ws$ ros2 launch tiago_cartographer tiago_cartographer.launch.py use_sim_time:=true
